        ...
        <div className='flex'>
            ...
            <div className='w-1/2 mt-[7%] ml-[17%]'>
                ...
                <div className='relative'>
                    ...
                    <input onChange={handleEmail} className='w-[368px] border-[3px] rounded-[10px] outline-none py-[26px] px-[48px] font-semibold  text-[20.64px] placeholder-[#11175D]' type="text" placeholder='Useremail@gmail.com' />
               ...
               <p>Full Name</p>
                ...
                <div className='relative mb-[51.86px] w-[368px]'>
                    {
                        showpassword ? (<FaEyeSlash 
                            ...
                            className='absolute top-[40%] right-[20px] text-xl cursor-pointer text-[#B2BFC3]' />)
                         :
                        (<FaEye
                            onClick={() => setshowpassword (!showpassword)}
                ...
                <h4 className='w-[368px] text-center mt-[35px] font-normal text-[13.34px] text-[#03014C]'>Already  have an account ? <span className='text-[#EA6C00] cursor-pointer font-bold text-[13.34px]'>Login</span> </h4>
